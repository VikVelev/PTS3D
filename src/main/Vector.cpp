...
// Transform the current vector to unit vector, effectively
// the same as the normalize function, but this one is local
...
// Operator overloading so we can add/multiply/divide
// vectors easily
